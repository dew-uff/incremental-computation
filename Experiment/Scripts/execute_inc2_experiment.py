# Scripts run experiment inc2, variable batch size based on date,
...
data_exec_ant = "2024-01-03 00:00"
    ...
    with connect_to_db() as conn:
        try:
            with conn.cursor() as cursor:
                ...
                #print("================================")
                cursor.execute(script)  # Usando ambas as datas com %s
...
def save_metrics_to_csv(metrics, cod_ver_exec, data_exec, cod_base, filename="etl_metrics_inc2.csv"):
    """
